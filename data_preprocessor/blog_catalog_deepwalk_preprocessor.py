...
def save_graph_to_edge_list(graph, node_labels, fname='blog-catalog'):
...
def main():
    data_flickr_file = '../raw_data/blog-catalog-deepwalk/blogcatalog.mat'
    flickr_graph, flickr_node_info = load_graph_from_mat(data_flickr_file)
    save_graph_to_edge_list(flickr_graph, flickr_node_info['labels'])
