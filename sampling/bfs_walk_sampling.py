...
class BfsWalkSampling(StaticClassSampling):
    """ We approximate BFS sampling by setting p to a small value and q to a big value in node2vec sampling """
    ...
    def __init__(self, G, edge_file, is_direct, **kwargs):
        ...
        self.name = 'approximate-bfs-walk'
