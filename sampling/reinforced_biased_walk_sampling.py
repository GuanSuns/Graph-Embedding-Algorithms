...
class ReinforcedBiasedRandomWalkSampling(StaticClassSampling):
    ...
    def __init__(self, G, edge_file, is_direct, **kwargs):
        ...
        self.i_value = kwargs['i_value']  # the initialization value of phenomenon, default=1.0
        self.window_size = kwargs['window_size']
        self.name = 'reinforced-biased-random-walk'
    ...
    def get_description(self):
        return {'name': self.get_name(), 'walk_length': self.walk_length, 'num_walks_iter': self.num_walks_iter, 'i_value': self.i_value}
